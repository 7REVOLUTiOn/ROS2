...
#ifndef _WIN32
# define DEPRECATED__my_service_interfaces__srv__SetVelocity_Event __attribute__((deprecated))
#else
# define DEPRECATED__my_service_interfaces__srv__SetVelocity_Event __declspec(deprecated)
#endif
...
struct SetVelocity_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<my_service_interfaces::srv::SetVelocity_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_service_interfaces::srv::SetVelocity_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<my_service_interfaces::srv::SetVelocity_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_service_interfaces::srv::SetVelocity_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<my_service_interfaces::srv::SetVelocity_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_service_interfaces::srv::SetVelocity_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<my_service_interfaces::srv::SetVelocity_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_service_interfaces::srv::SetVelocity_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__my_service_interfaces__srv__SetVelocity_Event
    std::shared_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__my_service_interfaces__srv__SetVelocity_Event
    std::shared_ptr<my_service_interfaces::srv::SetVelocity_Event_<ContainerAllocator> const>
...
using SetVelocity_Event =
  my_service_interfaces::srv::SetVelocity_Event_<std::allocator<void>>;
...
struct SetVelocity
{
  ...
  using Event = my_service_interfaces::srv::SetVelocity_Event;
};
